...
public class WindowInfo
{
    ...
    /// </summary>
    public ObjectId WindowId { get; set; }
    ...
    public WindowInfo()
    {
        WindowId = ObjectId.NewObjectId(); // Generate a new ObjectId
    ...
    public WindowInfo(string processName, string windowTitle, Point position, Size size) : this()
    {
        ...
        Position = position;
        Size = size;
        // WindowId will be auto-generated by LiteDB
    }
    ...
    public bool IsValid()
    {
        return WindowId != ObjectId.Empty &&
